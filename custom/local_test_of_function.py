...
'''
from AIModelDesign import AICustomFunction
'''from custom.functions import AICustomFunction'''

fn = AICustomFunction(BPT1=30,BPT2=40,BPT3=50,BPT4=60,BPT5=55,BPT6=66,BPT7=77,BPT8=88, Powerup_Steam_Flow_Rate=10,
...
db.register_functions([AICustomFunction])

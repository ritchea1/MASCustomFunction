...
'''
from AIModelDesign import AIFunctionCustom
'''from custom.functions import AIFunctionCustom'''

fn = AIFunctionCustom(BPT1=30,BPT2=40,BPT3=50,BPT4=60,BPT5=55,BPT6=66,BPT7=77,BPT8=88, Powerup_Steam_Flow_Rate=10,

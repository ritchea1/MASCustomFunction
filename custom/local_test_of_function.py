...
'''
from AIModelDesign import AIModelDesign
'''from custom.functions import AICustomModel'''

fn = AIModelDesign(BPT1=30,BPT2=40,BPT3=50,BPT4=60,BPT5=55,BPT6=66,BPT7=77,BPT8=88, Powerup_Steam_Flow_Rate=10,
Ratio_outlet_inlet_temp=20,Turbine_Inlet_Temperature=30,Turbine_Outlet_Temperature=40,Vibration=50,prediction=0)
...
'''db.register_functions([AICustomModel])'''

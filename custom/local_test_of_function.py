...
'''
from AIModelDesign import AITestDesign
'''from custom.functions import AITestDesign'''

fn = AITestDesign(BPT1=30,BPT2=40,BPT3=50,BPT4=60,BPT5=55,BPT6=66,BPT7=77,BPT8=88, Powerup_Steam_Flow_Rate=10,
...
db.register_functions([AITestDesign])
